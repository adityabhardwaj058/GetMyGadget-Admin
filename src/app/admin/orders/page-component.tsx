...
export default function OrdersPageComponent({ ordersWithProducts }: Props) {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Orders Management Table</h1>
      <Table>
        <TableHeader>
          <TableRow>
          ...
          {ordersWithProducts.map((order) => {
            return (
              <TableRow key={order.id}>
                ...
                {/* @ts-expect-error  this is necessary as supabase does not recognise that we do have an email*/}
