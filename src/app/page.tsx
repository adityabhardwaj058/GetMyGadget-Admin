  ...
  return (
    <div className="min-h-screen">
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold">GetMyGadget</h1>
      </header>
      <main className="container mx-auto px-4 py-12">
        <section className="mb-24f">
            ...
            <div className="w-1/3">
              ...
              >
                <Image
                  ...
                  height={888}
                  src="/app-pics.png"
                  alt="GetMyGadget Screenshot"
                  className="rounded-3xl object-cover shadow-2xl mx-auto h-[500px]"
                />
